...
static size_t _align_forward_pow2(size_t value, size_t align) {
...
static hll_memory_arena_block *alloc_block(size_t size, size_t align) {
...
static void _free_last_block(hll_memory_arena *arena) {
  hll_memory_arena_block *block = arena->block;
