...
hll_interpret_bytecode(hll_vm *vm, hll_bytecode *bytecode) {
    ...
    while ((op = *ip++) != HLL_BYTECODE_END) {
        switch (op) {
        case HLL_BYTECODE_POP: hll_sb_pop(stack); break;
        case HLL_BYTECODE_NIL: hll_sb_push(stack, vm->nil); break;
        case HLL_BYTECODE_TRUE: hll_sb_push(stack, vm->true_); break;
        ...
        case HLL_BYTECODE_FIND: break;
        case HLL_BYTECODE_CALL: break;
        case HLL_BYTECODE_JN: break;
        case HLL_BYTECODE_MAKE_LAMBDA: break;
        case HLL_BYTECODE_LET: break;
        case HLL_BYTECODE_PUSHENV: break;
        case HLL_BYTECODE_POPENV: break;
        case HLL_BYTECODE_CAR: break;
        case HLL_BYTECODE_CDR: break;
        case HLL_BYTECODE_SETCAR: break;
        case HLL_BYTECODE_SETCDR: break;
        default: assert(!"Unknown instruction"); break;
        }
    }
