...
#define hll_sb_header(_a) ((hll_sb_header *)((char *)(_a) - sizeof(hll_sb_header)))
#define hll_sb_size(_a) (hll_sb_header(_a)->size)
#define hll_sb_capacity(_a) (hll_sb_header(_a)->capacity)

#define hll_sb_needgrow(_a, _n) (((_a) == NULL) || (hll_sb_size(_a) + (_n) >= hll_sb_capacity(_a)))
#define hll_sb_maybegrow(_a, _n) (hll_sb_needgrow(_a, _n) ? hll_sb_grow(_a, _n) : 0)
#define hll_sb_grow(_a, _b) (*(void **)(&(_a)) = hll_sb_grow_impl((_a), (_b), sizeof(*(_a))))
